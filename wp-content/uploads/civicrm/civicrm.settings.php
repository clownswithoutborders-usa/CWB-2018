...
global $civicrm_setting;
 //$civicrm_setting['Directory Preferences']['customTemplateDir'] = '/www/www/wp-content/civicrm/templates/';
 //$civicrm_setting['Directory Preferences']['customPHPPathDir'] = '/www/www/wp-content/civicrm/php/';
 $civicrm_setting['Directory Preferences']['extensionsDir'] = '/home/clowns/www/www/wp-content/civicrm/extensions/';
 $civicrm_setting['URL Preferences']['extensionsURL'] = 'https://clownswithoutborders.org/wp-content/civicrm/extensions/';
 $civicrm_setting['URL Preferences']['imageUploadURL'] = 'https://clownswithoutborders.org/wp-content/uploads/civicrm/persist/contribute/';
 $civicrm_setting['URL Preferences']['userFrameworkResourceURL'] = 'https://clownswithoutborders.org/wp-content/plugins/civicrm/civicrm/';
...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://wp925:j8#4k$gGo@F@localhost/clowns_wpcivi?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://wp925:j8#4k$gGo@F@localhost/clowns_wpcivi?new_link=true');
  }
}
...
$civicrm_root = '/home/clowns/www/www/wp-content/plugins/civicrm/civicrm/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/home/clowns/www/www/wp-content/uploads/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://clownswithoutborders.org/');
}
